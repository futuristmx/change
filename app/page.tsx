  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1 }}>
          ...
          <div style={{ width: WRAP, margin: "0 auto", padding: "clamp(92px,11vw,168px) 0" }}>
            ...
            <div className="ch-staterow" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }}>
              {[
                ...
                { n: "Estado 04", h: "Criterio gobernado", p: "Revisable, transferible y sostenible.", w: "100%", bar: "var(--change-violet)", track: "rgba(109,59,255,.18)", bg: "rgba(109,59,255,.05)", emph: true },
              ].map((s, i) => (
            ...
            <Reveal style={{ border: "1px solid var(--border-subtle)", background: "rgba(255,255,255,.7)" }}>
              {[
                ...
                <div key={m.n} className="ch-mrow" style={{ display: "grid", gridTemplateColumns: "120px 230px 1fr", alignItems: "stretch", gap: 24, padding: "0 28px 0 0", borderBottom: i < arr.length - 1 ? "1px solid var(--border-subtle)" : "none" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}><h3 style={{ margin: 0, font: "600 20px var(--font-primary)", letterSpacing: "-.02em", color: "#1B191F" }}>{m.h}</h3></div>
            ...
            <div className="ch-grid3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
              {[
                ...
                <Reveal key={r.n} delay={i * 120} as="article" className="ch-card" style={{ border: "1px solid var(--border-subtle)", background: "rgba(255,255,255,.8)", padding: "36px 32px" }}>
                  ...
                  <h3 style={{ margin: "18px 0 10px", font: "600 23px var(--font-primary)", letterSpacing: "-.03em", color: "#1B191F" }}>{r.h}</h3>
        ...
        <section className="change-dark" style={{ position: "relative", overflow: "hidden", background: "radial-gradient(circle at 82% 0%,rgba(109,59,255,.22),transparent 38%),linear-gradient(180deg,#0E0D12 0%,#16151C 100%)" }}>
          ...
          <div style={{ width: WRAP, margin: "0 auto", padding: "clamp(92px,11vw,168px) 0" }}>
            <div className="ch-teamstrip" style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(330px,460px)", gap: "clamp(44px,5vw,80px)", alignItems: "start" }}>
              ...
              <Reveal delay={120} as="aside" className="ch-card" style={{ border: "1px solid var(--border-subtle)", background: "rgba(255,255,255,.85)", padding: "32px 30px" }}>
                <h3 style={{ margin: "0 0 24px", font: "600 20px var(--font-primary)", letterSpacing: "-.02em", color: "#1B191F" }}>Una mesa senior, no una fábrica de entregables.</h3>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  {[
                    ...
                    <div key={m.n} style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "baseline", padding: "15px 0", borderTop: "1px solid var(--border-subtle)" }}>
                      <strong style={{ font: "600 16px var(--font-primary)", color: "#1B191F" }}>{m.n}</strong>
        ...
        {/* ═══ CTA FINAL (dark) ═══ */}
        <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(circle at 50% -10%,rgba(109,59,255,.24),transparent 52%),#16151C" }}>
