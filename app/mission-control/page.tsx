    ...
    >
      ...
      <section style={{ background: "linear-gradient(180deg,var(--surface-dark-secondary),var(--surface-dark))" }}>
        <div style={{ width: WRAP, margin: "0 auto", padding: "clamp(80px,10vw,150px) 0" }}>
          ...
          <Reveal delay={60} as="h2" style={{ margin: "0 0 8px", maxWidth: "22ch", font: "600 clamp(30px,4.2vw,58px)/.99 var(--font-primary)", letterSpacing: "-.05em", color: "#fff", textWrap: "balance" }}>Memoria Viva: la continuidad estratégica de cada relación con Change.</Reveal>
          <Reveal delay={100} as="p" style={{ margin: "0 0 clamp(32px,4vw,40px)", maxWidth: "62ch", font: "400 clamp(16px,1.3vw,19px)/1.55 var(--font-primary)", color: "rgba(255,255,255,.8)" }}>Mission Control es la memoria estratégica donde quedan vivos los criterios, señales, decisiones y rumbo de cada relación con Change. No es un producto que se compra: es la infraestructura de continuidad que queda instalada cuando una decisión necesita sostenerse en el tiempo.</Reveal>
